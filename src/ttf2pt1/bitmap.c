...
)
{
	...
	int i, a1, a2, ndots; /* removed unused 'j' */
...
)
{
	...
	if(vectorize) {
		...
		int i;
		(void)i; /* silence -Wunused-variable */
		int skip;
...
#undef CHKCURVCONN
				...
				do { /* pass 2 */
					...
					GEX_FRAG *ff, *xf; /* removed unused '*lf' */
